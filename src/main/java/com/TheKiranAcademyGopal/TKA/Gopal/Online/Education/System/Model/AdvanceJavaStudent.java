...
@Entity
public class AdvanceJavaStudent {
	...
	public AdvanceJavaStudent() {
		super();
		// TODO Auto-generated constructor stub
	}

	public AdvanceJavaStudent(int id, String fname, String lname, String bday, String bmonth, String byear, String email,
	...
	public String toString() {
		return "JavaStudent [id=" + id + ", fname=" + fname + ", lname=" + lname + ", bday=" + bday + ", bmonth="
